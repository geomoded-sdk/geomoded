...
function(setup_geode_mod proname)
    ...
    if(GEODE_CLI STREQUAL "GEODE_CLI-NOTFOUND")
        message(FATAL_ERROR
            ...
            "Please install CLI: https://docs.geomoded-sdk.org/"
        )
        return()
    endif()
        ...
        if (HAS_HEADERS)
            add_custom_target(${proname}_PACKAGE ALL
                ...
                COMMAND ${GEODE_CLI} package new ${CMAKE_CURRENT_SOURCE_DIR} 
                    ...
                    --output ${CMAKE_CURRENT_BINARY_DIR}/${MOD_ID}.geomoded
                    ${INSTALL_ARG} ${PDB_ARG}
...
function(package_geode_resources_now proname src dest header_dest)
    ...
    foreach(file ${RESOURCE_FILES})
        ...
        if (NOT FILE_NAME STREQUAL ".geomoded_cache" AND NOT FILE_SHOULD_HASH EQUAL -1)
        ...
        if (NOT FILE_NAME STREQUAL ".geomoded_cache" AND NOT FILE_SHOULD_TEXT_HASH EQUAL -1)
