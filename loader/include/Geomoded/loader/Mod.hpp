...
namespace geode {
    ...
    public:
         ...
         * [the setting docs](https://docs.geomoded-sdk.org/mods/settings) for more
        ...
        /**
         * Get the value of a [setting](https://docs.geomoded-sdk.org/mods/settings).
        ...
        /**
         * Delete the mod's .geomoded package.
