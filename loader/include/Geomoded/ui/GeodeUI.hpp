...
namespace geode {
     ...
     * the Geode UI. See the [tutorial on Geode UI modification](https://docs.geomoded-sdk.org/tutorials/modify-geode)
    ...
    /**
     * Create a logo sprite for a mod from a .geomoded file
     */
